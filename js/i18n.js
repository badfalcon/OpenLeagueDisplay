...
export const UI_STRINGS = {
  default: {
    ...
    select_hint: "Click to add/remove · On home, click a champion to toggle all its skins · Point Windows slideshow at the downloaded folder → your own LeagueDisplays",
    clear: "Clear",
  ...
  ja_jp: {
    ...
    select_hint: "クリックで追加/解除 · ホームではチャンピオン丸ごと追加 · DLしたフォルダを Windows のスライドショーに指定すると、自分だけの League Display に",
    clear: "クリア",
  ...
  ko_kr: {
    ...
    select_hint: "클릭하여 추가/제거 · 홈에서는 챔피언 클릭으로 전체 토글 · 다운로드한 폴더를 Windows 슬라이드쇼 원본으로 지정하면 나만의 League Display",
    clear: "지우기",
  ...
  zh_cn: {
    ...
    select_hint: "点击添加/移除 · 首页点击英雄可切换其全部皮肤 · 将下载的文件夹设为 Windows 幻灯片来源，即可拥有专属 League Display",
    clear: "清除",
  ...
  zh_tw: {
    ...
    select_hint: "點擊加入/移除 · 首頁點擊英雄可切換其全部造型 · 將下載的資料夾設為 Windows 投影片來源，即為專屬 League Display",
    clear: "清除",
  ...
  fr_fr: {
    ...
    select_hint: "Cliquer pour ajouter/retirer · Sur l'accueil, cliquer sur un champion bascule tous ses skins · Définissez le dossier téléchargé comme source du diaporama Windows → votre propre LeagueDisplays",
    clear: "Effacer",
  ...
  de_de: {
    ...
    select_hint: "Klicken zum Hinzufügen/Entfernen · Auf der Startseite Champion klicken schaltet alle Skins · Den heruntergeladenen Ordner als Diashow-Quelle in Windows festlegen → dein eigenes LeagueDisplays",
    clear: "Löschen",
  ...
  es_es: {
    ...
    select_hint: "Clic para añadir/quitar · En el inicio, clic en un campeón alterna todos sus aspectos · Usa la carpeta descargada como origen del pase de diapositivas de Windows → tu propio LeagueDisplays",
    clear: "Limpiar",
  ...
  pt_br: {
    ...
    select_hint: "Clique para adicionar/remover · Na home, clique no campeão alterna todas as skins · Use a pasta baixada como origem da apresentação do Windows → seu próprio LeagueDisplays",
    clear: "Limpar",
  ...
  ru_ru: {
    ...
    select_hint: "Клик — добавить/убрать · На главной клик по чемпиону переключает все его образы · Укажите скачанную папку как источник слайд-шоу Windows — это ваш собственный LeagueDisplays",
    clear: "Очистить",
