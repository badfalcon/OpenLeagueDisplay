...
export const UI_STRINGS = {
  default: {
    ...
    select_hint: "Point Windows slideshow at the downloaded folder → your own LeagueDisplays",
    clear: "Clear",
  ...
  ja_jp: {
    ...
    select_hint: "DLしたフォルダを Windows のスライドショーに指定すると、自分だけの League Display に",
    clear: "クリア",
  ...
  ko_kr: {
    ...
    select_hint: "다운로드한 폴더를 Windows 슬라이드쇼 원본으로 지정하면 나만의 League Display",
    clear: "지우기",
  ...
  zh_cn: {
    ...
    select_hint: "将下载的文件夹设为 Windows 幻灯片来源，即可拥有专属 League Display",
    clear: "清除",
  ...
  zh_tw: {
    ...
    select_hint: "將下載的資料夾設為 Windows 投影片來源，即為專屬 League Display",
    clear: "清除",
  ...
  fr_fr: {
    ...
    select_hint: "Définissez le dossier téléchargé comme source du diaporama Windows → votre propre LeagueDisplays",
    clear: "Effacer",
  ...
  de_de: {
    ...
    select_hint: "Den heruntergeladenen Ordner als Diashow-Quelle in Windows festlegen → dein eigenes LeagueDisplays",
    clear: "Löschen",
  ...
  es_es: {
    ...
    select_hint: "Usa la carpeta descargada como origen del pase de diapositivas de Windows → tu propio LeagueDisplays",
    clear: "Limpiar",
  ...
  pt_br: {
    ...
    select_hint: "Use a pasta baixada como origem da apresentação do Windows → seu próprio LeagueDisplays",
    clear: "Limpar",
  ...
  ru_ru: {
    ...
    select_hint: "Укажите скачанную папку как источник слайд-шоу Windows — это ваш собственный LeagueDisplays",
    clear: "Очистить",
