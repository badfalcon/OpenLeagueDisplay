...
export const UI_STRINGS = {
  default: {
    ...
    dl_choice_zip: "Just download the ZIP",
    open_in_desktop: "🖥 Open in desktop app",
    handoff_title: "Open your selection in the desktop app",
    handoff_body: "This sends your selected splashes to the OpenLeagueDisplay desktop app so you can set them as wallpaper in one click. The desktop app must already be running on this PC (default port 8000).",
    ...
    import_none: "No new skins to import from that file.",
  ...
  ja_jp: {
    ...
    dl_choice_zip: "このまま ZIP をダウンロード",
    open_in_desktop: "🖥 デスクトップ版で開く",
    handoff_title: "選択をデスクトップ版で開く",
    handoff_body: "選んだスプラッシュを OpenLeagueDisplay デスクトップ版に送り、1クリックで壁紙にできます。このPCでデスクトップ版が起動している必要があります（既定ポート 8000）。",
    ...
    import_none: "そのファイルから取り込める新しいスキンがありません。",
