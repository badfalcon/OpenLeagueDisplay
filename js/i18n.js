...
export const UI_STRINGS = {
  default: {
    ...
    handoff_sent: "Sent {0} skins to the desktop app ✓",
    handoff_launch_ok: "Desktop app is up — your gallery was handed over ✓",
    handoff_launch_timeout: "Couldn't confirm the desktop app started. It may not be installed on this PC (setup.exe).",
    desktop_chip_on: "🖥 Desktop app connected ✓",
    desktop_chip_off: "🖥 Desktop app not detected",
    desktop_chip_checking: "🖥 Checking…",
    desktop_chip_title: "Click to check for the desktop app on this PC",
    ...
    // LoLSkinder (hidden "Tinder for skins" easter egg — js/skinder.js)
    skinder_title: "LoLSkinder",
    skinder_subtitle: "Swipe · Match · Collect",
    skinder_like: "Like",
    skinder_nope: "Pass",
    skinder_undo: "Undo",
    skinder_close: "Close",
    skinder_like_stamp: "LIKE",
    skinder_nope_stamp: "NOPE",
    skinder_counter: "{0} / {1}",
    skinder_liked_count: "♥ {0}",
    skinder_hint: "Swipe the card, or use ← / →. ♥ adds it to My Gallery.",
    skinder_done_title: "That's every skin!",
    skinder_done_body: "You matched {0} skins — they're waiting in My Gallery.",
    skinder_done_gallery: "Open My Gallery",
    skinder_done_restart: "Swipe again",
    skinder_done_close: "Done",
  ...
  ja_jp: {
    ...
    handoff_sent: "デスクトップ版に {0} 件を送信しました ✓",
    handoff_launch_ok: "デスクトップ版が起動しました — ギャラリーを受け渡し済みです ✓",
    handoff_launch_timeout: "デスクトップ版の起動を確認できませんでした。このPCにインストーラ版 (setup.exe) が入っていない可能性があります。",
    desktop_chip_on: "🖥 デスクトップ版: 接続中 ✓",
    desktop_chip_off: "🖥 デスクトップ版: 未検出",
    desktop_chip_checking: "🖥 確認中…",
    desktop_chip_title: "クリックでこのPCのデスクトップ版を確認します",
    ...
    // LoLSkinder (隠し機能: スキン版 Tinder — js/skinder.js)
    skinder_title: "LoLSkinder",
    skinder_subtitle: "スワイプ · マッチ · コレクト",
    skinder_like: "いいね",
    skinder_nope: "見送り",
    skinder_undo: "取り消し",
    skinder_close: "閉じる",
    ...
    skinder_counter: "{0} / {1}",
    skinder_liked_count: "♥ {0}",
    skinder_hint: "カードをスワイプ、または ← / → で操作。♥ でマイギャラリーに追加。",
    skinder_done_title: "全部見ました！",
    skinder_done_body: "{0} 枚をマッチしました — マイギャラリーで待っています。",
    skinder_done_gallery: "マイギャラリーを開く",
    skinder_done_restart: "もう一度スワイプ",
    skinder_done_close: "完了",
