...
export const UI_STRINGS = {
  default: {
    ...
    tut_s3_body: "Click any splash to open it full-size.<br><strong>Slideshow</strong> plays your gallery as a fullscreen show.<br>Use the flag button to switch language.<br><br>Press <code>?</code> anytime to reopen this guide.",
  },
  ja_jp: {
    ...
    tut_s3_title: "他の機能",
    tut_s3_body: "スプラッシュをクリックすると拡大表示。<br><strong>スライドショー</strong> ボタンでギャラリーを全画面再生。<br>国旗ボタンから表示言語を切替できます。<br><br><code>?</code> キーでいつでもこのガイドを再表示。",
  },
  ko_kr: {
    ...
    tut_s3_title: "더 알아보기",
    tut_s3_body: "스플래시를 클릭하면 확대해서 볼 수 있습니다.<br><strong>슬라이드쇼</strong> 버튼으로 갤러리를 전체화면 재생.<br>국기 버튼으로 표시 언어를 바꿀 수 있습니다.<br><br><code>?</code> 키로 언제든지 이 가이드를 다시 열 수 있습니다.",
  },
  zh_cn: {
    ...
    tut_s3_title: "更多功能",
    tut_s3_body: "点击任意原画即可放大查看。<br><strong>幻灯片</strong> 按钮可全屏播放你的画廊。<br>使用国旗按钮切换显示语言。<br><br>按 <code>?</code> 随时打开此指南。",
  },
  zh_tw: {
    ...
    tut_s3_title: "其他功能",
    tut_s3_body: "點選任一原畫即可放大檢視。<br><strong>幻燈片</strong> 按鈕可全螢幕播放你的畫廊。<br>透過國旗按鈕切換顯示語言。<br><br>按 <code>?</code> 隨時開啟此指南。",
  },
  fr_fr: {
    ...
    tut_s3_body: "Cliquez sur n'importe quel splash pour l'ouvrir en grand.<br><strong>Diaporama</strong> joue votre galerie en plein écran.<br>Changez de langue avec le bouton drapeau.<br><br>Appuyez sur <code>?</code> à tout moment pour rouvrir ce guide.",
  },
  de_de: {
    ...
    tut_s3_body: "Klicke einen Splash an, um ihn groß zu öffnen.<br><strong>Diashow</strong> spielt deine Galerie im Vollbild ab.<br>Wechsle die Sprache über die Flaggen-Schaltfläche.<br><br>Drücke <code>?</code> jederzeit, um diese Anleitung erneut zu öffnen.",
  },
  es_es: {
    ...
    tut_s3_body: "Haz clic en cualquier splash para verlo a tamaño completo.<br><strong>Diapositivas</strong> reproduce tu galería a pantalla completa.<br>Cambia el idioma con el botón de bandera.<br><br>Pulsa <code>?</code> en cualquier momento para reabrir esta guía.",
  },
  pt_br: {
    ...
    tut_s3_body: "Clique em qualquer splash para abrir em tela cheia.<br><strong>Slideshow</strong> reproduz sua galeria em tela cheia.<br>Mude o idioma com o botão de bandeira.<br><br>Pressione <code>?</code> a qualquer momento para reabrir este guia.",
  },
  ru_ru: {
    ...
    tut_s3_body: "Кликните по сплэшу, чтобы открыть его в полный размер.<br><strong>Слайд-шоу</strong> воспроизводит вашу галерею во весь экран.<br>Меняйте язык кнопкой с флагом.<br><br>Нажмите <code>?</code> в любой момент, чтобы открыть это руководство снова.",
  },
};
